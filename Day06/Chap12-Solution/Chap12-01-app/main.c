...
#pragma region strcmp(), strncmp() 함수
	...
	//printf("%d\n", strcmp(str5, str6)); //1
	if (strcmp(str5, str6) > 0) printf("%s\n", str5);
	else if (strcmp(str5, str6) == 0) printf("%s 같은단어\n", str5);
	else printf("%s \n", str6);

	int result = strncmp(str5, str6, 3); //pear랑 peach를 앞3 글자만 비교

	if (result == 0) printf("앞 3글자가 동일합니다.\n");
